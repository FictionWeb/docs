...
Fiction supports CGI scripts and includes [fiction.serveCGI](/reference/fiction-serve-cgi) function for CGI routes
...
For all CGI features visit [FictionServeCGI](/reference/fiction-serve-cgi)